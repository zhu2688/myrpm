...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/opt/myrpm")
  ...
  CONFIG["configure_args"] = " '--prefix=/opt/myrpm' '--disable-install-doc' '--with-opt-dir=/opt/myrpm'"
  ...
  CONFIG["STATIC"] = ""
  CONFIG["ARCH_FLAG"] = ""
  CONFIG["DLDFLAGS"] = "-L/opt/myrpm/lib  -Wl,-R/opt/myrpm/lib "
  CONFIG["ALLOCA"] = ""
  CONFIG["codesign"] = ""
  CONFIG["POSTLINK"] = ":"
  ...
  CONFIG["CXX"] = "g++"
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = " $(DEFS) $(cppflags) -I/opt/myrpm/include"
  CONFIG["LDFLAGS"] = "-L.  -rdynamic -Wl,-export-dynamic -L/opt/myrpm/lib  -Wl,-R/opt/myrpm/lib "
